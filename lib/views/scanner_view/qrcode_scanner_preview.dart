...
final class QrCodeScannerPreview extends StatefulWidget {
  ...
  @override
  State<QrCodeScannerPreview> createState() => _QrCodeScannerPreviewState();
}

class _QrCodeScannerPreviewState extends State<QrCodeScannerPreview> {
